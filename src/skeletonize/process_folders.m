...
% For local trial
%FOLDER = 'data_trial\';
%output_folder = 'data_local_trial_swc\';

% For archive trial
FOLDER = '\\fs.ista.ac.at\group\siegegrp\AlVe\_Bioimaging\Alessandro\Anesthetics (female)\BRAIN\KXA\FKBP5\FKBP5KO';
...
output_folder = '\\fs.ista.ac.at\group\siegegrp\AlVe\_Bioimaging\Alessandro\Anesthetics (female)\BRAIN\KXA\FKBP5\FKBP5KO\SWC';
...
for i=1:length(ims_files)
    ...
    try
        ...
        extract_filaments_from_imaris(ims_full_fn, output_folder);
    catch
